...
/* EXPLANATION START
  ...
  Variables declared as a constant are "block scoped". This means
  that they are a constant in the scope in which the variable
  was declared. In this case the variable internal was declared
  in the myFunction scope which is the same scope accessible
  to the function nestedFunction().
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach(animal => answer.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`));
    return answer;
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    ...
    zooAnimals.map(animal => answer.push((animal.animal_name).toLowerCase()));
    return answer;
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    ...
    const result = zooAnimals.reduce(function (acc, obj) { return acc + obj.population; }, 0);
...
function CuboidMaker(infoDeets){
    this.length = infoDeets["length"];
    this.width = infoDeets["width"];
    this.height = infoDeets["height"];
}
...
const deets = {"length": 4, "width": 5, "height": 5};

const cuboidTwo = new CuboidMaker(deets);
